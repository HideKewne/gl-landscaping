      ...
      <section className="contact" id="contact">
        <div className="container">
          ...
          <div className="contact-card-wrapper">
            ...
            {/* ONE left badge (phone + email combined) */}
            <div className="contact-badge badge-left glass-card">
            ...
            {/* ONE right badge (contact info combined) */}
            <div className="contact-badge badge-right glass-card">
              <div className="badge-row">
